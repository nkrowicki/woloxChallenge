    ...
    <div className={styles.heroContainer}>
      <div className={styles.container}>
        <div className={styles.leftSide}>
          ...
          <button className={styles.followTwitter}>{t('section.buttonFollow')}</button>
        </div>

        <div className={styles.rightSide}>
          <h2 className={styles.hh2}>
            {t('section.title1')}<span className={`${styles.blueWolox} ${styles.boldText}`}>{t('section.title2')}</span>{" "}
            <span className={`${styles.greenWolox} ${styles.boldText} `}>{t('section.title3')}</span> {t('section.title4')}
          </h2>
        </div>
      </div>
    </div>
